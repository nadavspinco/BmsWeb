...
public class RemoveMemberFromAssignment extends HttpServlet {
    ...
    protected void doDelete(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        System.out.println("on do delete RemoveMemberFromAssignment");
        removeMemberFromAssignment(req, resp);
    }

    private void removeMemberFromAssignment(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try (BufferedReader reader = req.getReader()) {
            ...
            System.out.println("after gson - removeMemberFromAssignment");
