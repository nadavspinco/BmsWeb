...
@WebServlet(name = "HistoryAssignmentServlet", urlPatterns = "/historyAssignment")
public class HistoryAssignmentServlet extends HttpServlet {
    private Gson gson = new Gson();

    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        showHistoryAssignment(req, resp);
    }

    public void showHistoryAssignment(HttpServletRequest req, HttpServletResponse resp) {
        try (PrintWriter out = resp.getWriter()) {
            ...
            List<Registration> regiList = systemManagement.getHistoryRegistrationOfMember(member);
